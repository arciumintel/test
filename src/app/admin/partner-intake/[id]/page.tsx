      ...
      <div className="mx-auto mt-8 max-w-3xl">
        <PartnerIntakeForm
          ...
          initial={{
            ...
            contactX: intake.contactX,
            contactDiscord: intake.contactDiscord,
            contactTelegram: intake.contactTelegram,
            preferredContactMethod: intake.preferredContactMethod,
            projectName: intake.projectName,
            projectDescription: intake.projectDescription,
            officialWebsite: intake.officialWebsite,
            officialX: intake.officialX,
            officialDiscord: intake.officialDiscord,
            officialTelegram: intake.officialTelegram,
